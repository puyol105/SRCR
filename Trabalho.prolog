...
:- dynamic coordenada/3. % Id, X, Y
:- dynamic paragem/10. % Id, Id_Coord, Estado( Bom/Razoavel/Mau ), Tipo , Publicidade, Operadora, Carreira, Cod_Rua, Nome_Rua, Freguesia
...
:-include("dados.pl") %Introduzir outros ficheiros pl dentro deste, caso queira
